...
function isgameover(){
    ...
    clearTimeout(t);
    //游戏结束的提示
    $("#box_container").append("<div id='gameover' class='gameover'><p>本次用时</p><span>" + timerun.toString().substr(0,4) + "秒</span><a href='javascript:restartgame();' id='restartgamebutton'>Restart</a></div>");
...
function restartgame(){
    ...
    $("#gameover").remove();
    //将游戏的计时器重新归0
    $("#time_box").html("<span>0.00</span>"+"秒");
    //将上一次游戏的黑块部分清除
    $(".block").remove();
    //将统计游戏键盘敲击次数归0
    score = 0;
